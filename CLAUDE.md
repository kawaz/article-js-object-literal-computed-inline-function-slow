...
- **記事編集の前に**: 作業に入る前にまずその時点の記事全体を読んで内容を把握しておくこと
...
- **Zenn公開フロー**:
  - Zennリポジトリ: `$XDG_DATA_HOME/repos/github.com/kawaz/zenn`（相対パス: `../zenn`）
  ...
  - **推敲中はZenn側・英語版を毎回同期しない**（コンテキストの無駄。公開段階でまとめて1回やる）
...
- **ベンチマーク結果の表記**:
  ...
  - **同じ数値は精度を揃える**: 表で38.6%と書いて本文で39%と丸めるなど、同じ値の精度がバラつくと読者が別の値と誤認する
