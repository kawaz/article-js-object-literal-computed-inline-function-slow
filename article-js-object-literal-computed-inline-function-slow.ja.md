...
| 生成方法 | キー | キーの値 | 値の型 | 定義場所 | 結果 | 検証 |
|---|---|---|---|---|---|---|
| class | - | - | - | - | ✅ 速い | 検証1 |
| 後付け | static | - | 関数 | 変数経由 | ✅ 速い | 検証1 |
| 後付け | static | - | 関数 | 直接定義 | ✅ 速い | 検証1 |
| 後付け | computed | Symbol | 関数 | 変数経由 | ✅ 速い | 検証1 |
| 後付け | computed | Symbol | 関数 | 直接定義 | ✅ 速い | 検証1 |
| 後付け | computed | 通常 | 関数 | 変数経由 | ✅ 速い | 検証1 |
| 後付け | computed | 通常 | 関数 | 直接定義 | ✅ 速い | 検証1 |
