...
|---|---|---|
| クロージャの有無 | ✅ 無関係 | 検証2 |
| function / arrow / method の違い | ✅ 無関係 | 検証3 |
| Symbol vs 通常の computed property | ✅ 無関係 | 検証1 |
| using 構文 | ✅ 無関係 | 検証7 |
...
| 生成方法 | キー | 関数定義 | 結果 | 検証 |
|---|---|---|---|---|
| リテラル | static | 直接定義 | ✅ 速い | 検証1 |
| リテラル | static | 変数経由 | ✅ 速い | 検証1 |
| リテラル | computed | 直接定義 | 🔥 **遅い** | 検証1,5,6 |
| リテラル | computed | 変数経由 | ✅ 速い | 検証1,6 |
| 後付け | static | 直接定義 | ✅ 速い | 検証1 |
| 後付け | static | 変数経由 | ✅ 速い | 検証1 |
| 後付け | computed | 直接定義 | ✅ 速い | 検証1 |
| 後付け | computed | 変数経由 | ✅ 速い | 検証1 |
| class | - | - | ✅ 速い | 検証1 |

### 結論

上記の組み合わせ評価から、**「リテラル + computed + 直接定義」の組み合わせだけが遅い**ことが分かる。

遅くなる条件: **「オブジェクトリテラル」+「computed property」+「リテラル内での直接関数定義」**
