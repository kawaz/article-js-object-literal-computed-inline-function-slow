...
|---|---|---|---|---|---|---|---|---|
| class | - | - | - | - | - | - | ✅ 速い | 検証1 |
| 後付け | static | - | 関数 | 直接定義 | function | - | ✅ 速い | 検証1 |
| 後付け | static | - | 関数 | 直接定義 | arrow | - | ✅ 速い | 検証1 |
| 後付け | static | - | 関数 | 直接定義 | method | - | ✅ 速い | 検証1 |
| 後付け | static | - | 関数 | 変数経由 | - | - | ✅ 速い | 検証1 |
| 後付け | computed | Symbol | 関数 | 直接定義 | function | - | ✅ 速い | 検証1 |
| 後付け | computed | Symbol | 関数 | 直接定義 | arrow | - | ✅ 速い | 検証1 |
| 後付け | computed | Symbol | 関数 | 直接定義 | method | - | ✅ 速い | 検証1 |
| 後付け | computed | Symbol | 関数 | 変数経由 | - | - | ✅ 速い | 検証1 |
| 後付け | computed | 通常 | 関数 | 直接定義 | function | - | ✅ 速い | 検証1 |
| 後付け | computed | 通常 | 関数 | 直接定義 | arrow | - | ✅ 速い | 検証1 |
| 後付け | computed | 通常 | 関数 | 直接定義 | method | - | ✅ 速い | 検証1 |
| 後付け | computed | 通常 | 関数 | 変数経由 | - | - | ✅ 速い | 検証1 |
| リテラル | static | - | 関数 | 直接定義 | function | あり | ✅ 速い | 検証1,2 |
| リテラル | static | - | 関数 | 直接定義 | function | なし | ✅ 速い | 検証1,2 |
| リテラル | static | - | 関数 | 直接定義 | arrow | - | ✅ 速い | 検証1,3 |
| リテラル | static | - | 関数 | 直接定義 | method | - | ✅ 速い | 検証1,3 |
...
| **リテラル** | **computed** | **Symbol** | **関数** | **直接定義** | **function** | **あり** | 🔥 **遅い** | 検証1,2,5 |
| **リテラル** | **computed** | **Symbol** | **関数** | **直接定義** | **function** | **なし** | 🔥 **遅い** | 検証1,2,5 |
| **リテラル** | **computed** | **Symbol** | **関数** | **直接定義** | **arrow** | **-** | 🔥 **遅い** | 検証1,3,5 |
| **リテラル** | **computed** | **Symbol** | **関数** | **直接定義** | **method** | **-** | 🔥 **遅い** | 検証1,3,5 |
| **リテラル** | **computed** | **通常** | **関数** | **直接定義** | **function** | **あり** | 🔥 **遅い** | 検証1,2,5 |
| **リテラル** | **computed** | **通常** | **関数** | **直接定義** | **function** | **なし** | 🔥 **遅い** | 検証1,2,5 |
| **リテラル** | **computed** | **通常** | **関数** | **直接定義** | **arrow** | **-** | 🔥 **遅い** | 検証1,3,5 |
| **リテラル** | **computed** | **通常** | **関数** | **直接定義** | **method** | **-** | 🔥 **遅い** | 検証1,3,5 |
